...
enum sparklink_dli_event_code {
	SPARKLINK_DLI_EVT_CMD_STATUS		= 0x0001,
	SPARKLINK_DLI_EVT_CMD_COMPLETE		= 0x0002,
	SPARKLINK_DLI_EVT_DATA_LEN_CHANGE	= 0x0003,
	SPARKLINK_DLI_EVT_BROADCAST_END		= 0x0004,
	SPARKLINK_DLI_EVT_DISCONNECTED		= 0x0005,
	SPARKLINK_DLI_EVT_PEER_CONN_PARAM_REQ	= 0x0007,
	SPARKLINK_DLI_EVT_TX_POWER_CHANGE	= 0x0008,
	SPARKLINK_DLI_EVT_NUM_COMPLETED_PKTS	= 0x0009,
	SPARKLINK_DLI_EVT_HW_ERROR		= 0x000A,
	SPARKLINK_DLI_EVT_ENCRYPT_PARAM_REQ	= 0x000C,
	SPARKLINK_DLI_EVT_ENCRYPT_STATE_CHANGE	= 0x0011,
	SPARKLINK_DLI_EVT_CTRL_SIGNAL_DATA	= 0x0012,
	SPARKLINK_DLI_EVT_CONN_ESTABLISHED	= 0x0015,
	SPARKLINK_DLI_EVT_READ_PEER_FEATURES	= 0x0016,
	SPARKLINK_DLI_EVT_READ_PEER_VERSION	= 0x0017,
	SPARKLINK_DLI_EVT_PHY_PARAM_UPDATE	= 0x0018,
	SPARKLINK_DLI_EVT_CONN_PARAM_UPDATE	= 0x0019,
	SPARKLINK_DLI_EVT_BROADCAST_REPORT	= 0x001A,
	SPARKLINK_DLI_EVT_READ_PEER_TX_POWER	= 0x001B,
	SPARKLINK_DLI_EVT_INQUIRY_REQ_REPORT	= 0x001C,
	SPARKLINK_DLI_EVT_PAIR_REQUEST		= 0x001D,
};
